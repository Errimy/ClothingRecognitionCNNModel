...
app = Flask(__name__)
model = load_model(
    r'C:\Users\redat\PycharmProjects\CNNFashionMnist\CNNLab\Deploy_Model\static\model\HatimCNNModel.h5')
...
def predict_label(img_path):
    i = image.load_img(img_path,grayscale=True, target_size=(28, 28))#lakan pb chuf hna zid 1
